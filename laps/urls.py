...
urlpatterns = patterns('',
    ...
    url(r'^(?P<username>[A-Za-z0-9_]+)/races/import/laptext$', races.import_race_from_lap_text, name='import_race_from_lap_text'),
    ...
    url(r'^(?P<username>[A-Za-z0-9_]+)/races/(?P<race_id>\d+)/chart_team_laps/?$', views.LapsTeamAJAXView.as_view(), name='chart_team_laps'),
